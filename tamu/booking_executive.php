           ...
           <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
               ...
               <li><a href="../contact_us.php" class="nav-link px-2 link-dark">Contact Us</a></li>
                ...
                <div class = "well" style = "height:300px; width:100%;">
                       ...
                       <p><img width="350" height="235 alt=" src="../img/offers/offers_bg_5.jpg" style="float:left; margin-right:40px;padding-top: 10px"></p>
                        <right><h4 style = "color:black; margin-left: 400px; padding-top: 20px;">Executive Rooms</h4></right>
                        <right><h5 style = "color:rgba(0, 255, 0, 1); margin-left:0px; padding-left: 10px;">Rp 3.000.000</h5></right>
                </div>
                <br style = "clear:both;" />
