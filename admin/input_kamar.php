    ...
    <form action="simpan_tbkamar.php" method="post">
    	<table>
    		<tr>
    			<td>Nama kamar</td>
    			<td>:</td>
    			<td> <input type="text" name="nama_kamar" class="form_daftar"required="required"></td>
    		</tr>
            <tr>
    			<td>Fasilitas Kamar</td>
    			<td>:</td>
    			<td> <input type="text" name="fasilitas_kamar" class="form_daftar"required="required"></td>
    		</tr>
    		<tr>
                <td>Harga</td>
                <td>:</td>
                <td> <input type="text" name="harga_kamar" class="form_daftar"required="required"></td>
            </tr>
            <tr>
    			<td>jumlah</td>
    			<td>:</td>
                <td> <input type="number" name="jml_kamar" class="form_daftar"required="required"></td>
            </tr>
    		<td></td>
    		<td></td>
            <td></td>
         ...
         <td><a href="../admin/index_dasboard.php"><button>kembali</button></a></td>
