...
?>
        ...
        <h2 class="alert alert-light text-center bg-dark fixed-top shadow-lg ">Tabel Fasilitas</h2>
	<br/>
	<br><br><br>
		<div class="container">

	<a href="../admin/tambah_fasilitas.php"><button class="btn btn-success">+ Tambah Fasilitas</button></a>
		<br><br><br>
